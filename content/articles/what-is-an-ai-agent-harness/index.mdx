...
The term is ours. The MCP specification does not define a harness.<Cite sourceId="SRC-MCP-001" /> It defines a protocol. Kubernetes does not define a harness.<Cite sourceId="SRC-K8S-001" /> It defines how to schedule a process and how that process identifies itself. The gap between those two facts is the design problem.
