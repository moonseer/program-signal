...
<Callout type="watch">
The MCP specification states that the protocol **cannot enforce** its security principles at the protocol level. Implementors must add consent, authorization, and access control. Prompt hardening is not a substitute.
</Callout>
